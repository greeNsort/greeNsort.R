...
static void ZucksortB_TieLeft(
    ValueT *x
  , IndexT l, IndexT r
);

// pivot partioning placing all pivot ties high
static void ZucksortB_TieRight(
    ValueT *x
  , IndexT l, IndexT r
){
#if INSERTIONSORT_LIMIT > 0
  ...
  i = L - x;
  ZucksortB_TieRight(x, l, i-1);
  ZucksortB_TieLeft(x, i+1, r);
...
static void ZucksortB_TieLeft(
  ...
  ZucksortB_TieRight(x, l, j-1);
  ZucksortB_TieLeft(x, j+1, r);

  //}
}


void ZucksortB_insitu(
    ValueT *x
  , IndexT n
)
{
  ZucksortB_TieLeft(x, 0, n-1);
}

void ZucksortB_exsitu(
    ValueT *x
  , IndexT n
)
{
