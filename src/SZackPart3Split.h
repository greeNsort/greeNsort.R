/*
# greeNsort stable ternary buffer Partitioning
# Copyright (C) 2010-2024 Dr. Jens Oehlschaegel
# BSD-3 clause
# Provided 'as is', use at your own risk
*/

#ifndef ALREADY_DEFINED_SZackPart3Split_h
#define ALREADY_DEFINED_SZackPart3Split_h
...
static RangeIndexT SZackPart3Split(ValueT *x, ValueT *aux, IndexT l, IndexT r, IndexT k){
  IndexT i, il, ic, ir;
