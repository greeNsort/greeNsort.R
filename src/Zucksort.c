...
static void Zucksort_TieLeft(
    ValueT *x
  , IndexT l, IndexT r
);

// pivot partioning placing all pivot ties high
static void Zucksort_TieRight(
    ValueT *x
  , IndexT l, IndexT r
){
#if INSERTIONSORT_LIMIT > 0
  ...
  Zucksort_TieRight(x, l, i-1);
  Zucksort_TieLeft(x, i+1, r);
  //}
  // else all pivot ties
}
...
static void Zucksort_TieLeft(
  ...
  Zucksort_TieRight(x, l, j-1);
  Zucksort_TieLeft(x, j+1, r);
  //}
}



void Zucksort_insitu(
    ValueT *x
  , IndexT n
)
{
  Zucksort_TieLeft(x, 0, n-1);
}

void Zucksort_exsitu(
    ValueT *x
  , IndexT n
)
{
